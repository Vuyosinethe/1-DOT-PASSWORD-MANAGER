...
import { Plus, Copy, LogOut, Check, Eye } from "lucide-react"
...
import { PasswordViewModal } from "@/components/password-view-modal"
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const parsedUser = sessionResult.user
    setUser(parsedUser)
  ...
  const viewPassword = (entry: PasswordEntry) => {
    setSelectedEntry({
      id: entry.id,
